...
/datum/preferences
	...
	var/auto_punctuate = FALSE // VOID EDIT
...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		...
		if (3) // Game Preferences
			...
			dat += "<b>Autopunctuate your messages:</b> <a href='?_src_=prefs;preference=auto_punctuate'>[auto_punctuate ? "Enabled" : "Disabled"]</a><br>" // VOID EDIT
			dat += "<br>"
